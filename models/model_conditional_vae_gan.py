...
class GAN:
    ...
    def build_model(self):
        ...
        reconstruction_loss = tf.reduce_mean(tf.square(tf.subtract(fake_image, t_real_image)))
        ...
        g_loss = -1 * tf.reduce_mean(disc_fake_image) + kl_divergence + reconstruction_loss
        ...
        tf.summary.scalar("Generator vae reconstruction loss", reconstruction_loss)
