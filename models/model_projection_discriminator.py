...
class GAN:
    ...
    def discriminator(self, image, t_text_embedding, reuse=False):
        with tf.variable_scope("discriminator", reuse=tf.AUTO_REUSE):
            ...
            h3_new = ops.lrelu( self.d_bn4(ops.conv2d(h3, self.options['df_dim']*8, 1,1,1,1, name = 'd_h3_conv_new'))) #4
        ...
        return tf.nn.sigmoid(discriminator_output_logit), discriminator_output_logit
