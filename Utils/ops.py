...
from Utils.sn import spectral_normed_weight
...
# This function is from https://github.com/minhnhat93/tf-SNDCGAN
...
def conv2d_sn(input_, output_dim,
           k_h=5, k_w=5, d_h=2, d_w=2, stddev=None,
...
# This function is from https://github.com/minhnhat93/tf-SNDCGAN
def deconv2d_sn(input_, output_shape,
